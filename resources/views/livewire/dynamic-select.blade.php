<div>
    ...
    <div class="d-flex align-items-center justify-content-between mb-3">
        <div class="form-check">
            <input wire:model="selectedTransactionType" wire:click="updateTransactionType(2)" class="form-check-input"
                type="radio" name="type" id="expense" value="2" checked>
            <label class="form-check-label" for="expense">
                Expense
            </label>
        </div>
        <div class="form-check">
            <input wire:model="selectedTransactionType" wire:click="updateTransactionType(1)" class="form-check-input"
                type="radio" name="type" id="income" value="1">
